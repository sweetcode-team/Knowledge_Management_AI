\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        % NOME FILE
        \node [anchor=north east, text width=15cm, align=right, xshift=-1cm, yshift=16cm, text=black] (titolo) at (current page.south east){\fontsize{40pt}{40pt}\textbf{\titolo}};
        ...
        \node [xshift=-4.8cm, yshift=2.45cm] (logo) at (current page.south east) {\includegraphics[width=6cm]{img/gianluca.png}};
        \node[anchor=north west, xshift=12.9cm, yshift=1.45cm, align=left] at (current page.south west)
        {\fontsize{13pt}{13pt}\selectfont Il Responsabile: Bresolin G.};
