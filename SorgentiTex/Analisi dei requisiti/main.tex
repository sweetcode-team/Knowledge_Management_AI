...
\rql{O} & Il prodotto software deve rispettare tutto ciò che è descritto da (Norme di progetto). & Regolamento \\
\hline \rql{O} & Il prodotto software deve rispettare tutto ciò che è descritto da (Piano di qualifica). & Regolamento \\ 
\end{xltabular}
