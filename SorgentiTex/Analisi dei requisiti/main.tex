...
\subsection{Elenco dei casi d'uso}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item l'utente ha inserito un messaggio nell'area di input di una chat.
        \end{itemize}
        \item \textbf{Postcondizioni}: 
            \begin{itemize}
            ...
            \end{itemize}
        \item \textbf{Scenario principale}: l’utente conferma l'invio del messaggio inserito nell'area di input della chat;
    ...
    \begin{itemize}
        ...
        \item \textbf{Postcondizioni}: è stato inserito un messaggio nell'area di input da inviare nella chat selezionata;
    ...
    \begin{itemize}
        \item \textbf{Attore principale}: utente;
        \item \textbf{Precondizioni}: l’utente ha selezionato e sta visualizzando una chat;
        \item \textbf{Postcondizioni}: è stato inserito un messaggio nell'area di input testuale da inviare nella chat selezionata;
    ...
    \begin{itemize}
        ...
        \item \textbf{Scenario principale}:
            \begin{enumerate}
                ...
                \item l’utente indica vocalmente il messaggio che vuole inserire nell'area di input della chat.
            \end{enumerate}
...
\hline \rf{O} & L'utente deve poter cambiare la scelta del vector database. & \quantities{\rifuc{camb_scel_vd}\\ Verbale esterno (2023-11-24)} \\
\hline \subrf{O} & L'utente deve poter selezionare un solo vector database tra quelli resi disponibili durante il cambio di scelta del vector database. &  \quantities{\rifuc{camb_scel_vd}\\ Verbale esterno (2023-11-24)} \\
\hline \rf{O} & L'utente deve poter cambiare la scelta del modello di embeddings. & \quantities{\rifuc{camb_scel_emb}\\ Verbale esterno (2023-11-24)}\\
\hline \subrf{O} & L'utente deve poter selezionare un solo modello di embeddings tra quelli resi disponibili durante il cambio di scelta del modello di embeddings. &  \quantities{\rifuc{camb_scel_emb}\\ Verbale esterno (2023-11-24)} \\
\hline \rf{O} & L'utente deve poter cambiare la scelta del sistema di archiviazione documenti. & \quantities{\rifuc{camb_scel_sis}\\ Verbale esterno (2023-11-24)}\\
\hline \subrf{O} & L'utente deve poter selezionare un solo sistema di archiviazione dei documenti tra quelli resi disponibili durante il cambio di scelta del sistema di archiviazione dei documenti. &  \quantities{\rifuc{camb_scel_sis}\\ Verbale esterno (2023-11-24)} \\
...
\hline \subrf{O} & L'utente deve poter selezinare un insieme di documenti presenti nel sistema per eliminarli. & \rifuc{elim_docs} \\
...
\hline \subrf{O} & L'utente deve poter inserire un messaggio testuale nell'area di input in una chat. & \rifsubuc{ins_mess}{ins_mess_test} \\
\hline \subrf{O} & L'utente deve poter inserire un messaggio in una chat tramite comando vocale nell'area di input di una chat. & \quantities{ \rifsubuc{ins_mess}{ins_mess_voc}\\ Verbale esterno (2023-11-24)}\\
