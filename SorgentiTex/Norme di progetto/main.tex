...
\begin{itemize}
    ...
    \item \textbf{Configuration Management}: definisce le attività di gestione della configurazione;
...
\begin{itemize}
    \item \textbf{Docente del corso}: committente;
...
\begin{itemize}
    \item \textbf{Efficacia}: capacità di permettere all'utente di raggiungere obiettivi specifici con accuratezza e completezza in uno specifico contesto di utilizzo;
...
\begin{enumerate}
    ...
    \item Svolgimento dell'incontro tra il team attraverso la piattaforma \textit{Discord}, in cui i membri che hanno realizzato il materiale da sottoporre a revisione espongono rapidamente 
...
\href{https://docs.google.com/spreadsheets}{https://docs.google.com/spreadsheets}\\\\
...
\href{https://pypi.org/project/latexmk.py/}{https://pypi.org/project/latexmk.py/}
...
\subsection{Whatsapp}
\href{https://www.whatsapp.com}{https://www.whatsapp.com}
