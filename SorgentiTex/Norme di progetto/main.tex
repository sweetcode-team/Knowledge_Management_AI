...
all'interno del contesto del progetto universitario in atto, il team non ritiene i processi di \textit{Manutenzione} e \textit{Operazione} 
pertienenti (in quanto il progetto termina con la presentazione del \textit{MVP}) e, pertanto, si è deciso di escluderli dalla presentazione
nel documento.\\
