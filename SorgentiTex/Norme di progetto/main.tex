...
Il Processo di Acquisizione comprende le attività e i compiti dell'acquirente. Il processo inizia con la definizione della necessità di acquisire un sistema, un prodotto software o un servizio software. Il processo prosegue con la preparazione e l'emissione di una richiesta di proposta, la selezione di un fornitore e la gestione del processo di acquisizione fino all'accettazione del sistema, del prodotto software o del servizio software. L'organizzazione individuale che ha la necessità può essere chiamata il proprietario, ma nel contesto del progetto didattico sarà citata all'interno della documentazione come 'il proponente' o 'l'azienda'.
...
\begin{itemize}
    \item \textbf{Formazione dei gruppi di lavoro};
    \item \textbf{Presentazione dei capitolati d'appalto};
    \item \textbf{Presentazione delle candidature};
    \item \textbf{Aggiudicazione appalti}.
\end{itemize}
