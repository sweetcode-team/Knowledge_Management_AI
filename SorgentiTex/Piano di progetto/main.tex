...
All'interno dei documenti viene identificata con tale scrittura solo e soltanto la prima occorrenza presente nel testo del termine.\\
...
\begin{itemize}
    ...
    \item \textit{Presentazione capitolato\pg}:\\
...
La notazione utilizzata per identificare i rischi è descritta in (Norme di progetto v2.0.0(0)).
