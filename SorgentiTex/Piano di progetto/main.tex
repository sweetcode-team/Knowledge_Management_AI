...
\subsubsubsection{Obiettivi}
\begin{itemize}
    \item Conclusione progettazione di dettaglio;
    \item Inizio programmazione;
...
\textbf{Progettista} & 3 & 75,00\texteuro\\
\hline
\textbf{Programmatore} & 50 & 750,00 \texteuro \\ 
\hline
\textbf{Verificatore} & 33 & 495,00\texteuro \\ 
\hline
\rowcolor{primarycolor}
\textbf{Totale} & 97 & 1600,00\texteuro \\
\end{tabularx}
%}
...
\begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
    \textbf{Membri} & $\operatorname{\textbf{Re}}$ & $\mathrm{\textbf{Am}}$ & \textbf{An} & \textbf{Proj} & \textbf{Prgm} & \textbf{Ver} & \textbf{Totale} \\
        \hline Bresolin G. & 0 & 0 & 0 & 0 & 4 & \cellcolor{primarycolor}5 & 9 \\
        \hline Ciriolo I.  & 0 & 4 & 0 & 0 & \cellcolor{primarycolor}5 & 2 & 11 \\
        \hline Campese M.  & 0 & 0 & 0 & 0 & \cellcolor{primarycolor}2 & 3 & 5 \\
        \hline Dugo A.     & 5 & 0 & 0 & 0 & 2 & \cellcolor{primarycolor}3 & 10 \\
        \hline Feltrin E.  & 0 & 0 & 0 & \cellcolor{primarycolor}0 & 3 & 5 & 8 \\
        \hline Michelon R. & 0 & 0 & 0 & 0 & \cellcolor{primarycolor}0 & 8 & 8 \\
        \hline Orlandi G.  & \cellcolor{primarycolor}0 & 3 & 1 & 0 & 3 & 3 & 10 \\
        \hline
...
\hline
\rowcolor{primarycolor}
\textbf{Totale} & 61 & 1035,00\texteuro \\
\end{tabularx}
%}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \hline
        \textbf{PROG} & 48 & 56 & 8 & 720,00\texteuro & 840,00\texteuro & 120,00\texteuro \\
        \hline
        \textbf{VER}  & 29 & 29 & 0 & 435,00\texteuro & 435,00\texteuro & 0,00\texteuro \\
        \hline
        \rowcolor{primarycolor}
        \textbf{TOT} & 103 & 103 & 0 & 1815,00\texteuro & 1935,00\texteuro & 120,00\texteuro \\
    \end{tabularx}
...
\begin{itemize}
    \item Inizio codifica delle componenti software;
    \item Codifica delle componenti del backend e relativi test;
    \item Completamento della stesura del documento 'Specifica tecnica';
    \item Aggiornamento Analisi dei requisiti;
    \item Aggiornamento Piano di qualifica;
    \item Aggiornamento Piano di progetto;
    \item Stesura verbali relativi allo sprint.
...
\subsubsubsection{Rischi occorsi e loro mitigazione}
\begin{itemize}
    \item \textbf{RT.1}: la scarsa esperienza pregressa nell'ambito del implementazione di componenti software ha rallentato il raggiungimento degli obiettivi in questo sprint. Lo studio personale di dispense e documentazione relativa a tale ambito ha però permesso di portare a termine gli obiettivi prefissati nella realizzazione della codifica e nel completamento del documento "Specifica tecnica".
\end{itemize}
\subsubsubsection{Pianificazione futura}
\begin{itemize}
...
\subsubsection{Retrospettiva}
\begin{itemize}
    \item La codifica, sebbene sia stata molto impegnativa, ha evidenziato nel corso dello sprint un miglioramento in termini di efficienza temporale, grazie all'utilizzo di una impostazione uniforme e chiara definita dai membri del team ad inzio sprint;
