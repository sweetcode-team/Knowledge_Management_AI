...
\begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
    \textbf{Membri} & $\operatorname{\textbf{Re}}$ & $\mathrm{\textbf{Am}}$ & \textbf{An} & \textbf{Proj} & \textbf{Prgm} & \textbf{Ver} & \textbf{Totale} \\
        ...
        \hline Ciriolo I.  & 0 & 0 & 1 & 0 & \cellcolor{primarycolor}11 & 3 & 15 \\
        \hline Campese M.  & 0 & 0 & 1 & 2 & \cellcolor{primarycolor}12 & 1 & 16 \\
        \hline Dugo A.     & 0 & 0 & 0 & 0 & \cellcolor{primarycolor}10 & 4 & 14 \\
        \hline Feltrin E.  & 0 & 4 & 0 & 1 & 2 & \cellcolor{primarycolor}8 & 15 \\
        \hline Michelon R. & 0 & 0 & 0 & 0 & 1 & \cellcolor{primarycolor}7 & 8 \\
        \hline Orlandi G.  & 0 & 0 & 0 & 0 & 3 & \cellcolor{primarycolor}10 & 13 \\
        \hline
        \textbf{Totale ruolo} & 5 & 4 & 2 & 3 & 48 & 33 & 95 
    \end{tabularx}
...
\textbf{Programmatore} & 48 & 720,00 \texteuro \\ 
\hline
\textbf{Verificatore} & 33 & 495,00\texteuro \\ 
\hline
\rowcolor{primarycolor}
\textbf{Totale} & 95 & 1570,00\texteuro \\
\end{tabularx}
%}
...
\begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
    \textbf{Membri} & $\operatorname{\textbf{Re}}$ & $\mathrm{\textbf{Am}}$ & \textbf{An} & \textbf{Proj} & \textbf{Prgm} & \textbf{Ver} & \textbf{Totale} \\
        \hline Bresolin G. & 0 & 0 & 0 & 0 & 3 & \cellcolor{primarycolor}4 & 7 \\
        \hline Ciriolo I.  & 0 & 4 & 0 & 0 & \cellcolor{primarycolor}5 & 2 & 11 \\
        \hline Campese M.  & 0 & 0 & 0 & 0 & 1 & \cellcolor{primarycolor}3 & 5 \\
        \hline Dugo A.     & \cellcolor{primarycolor}5 & 0 & 0 & 0 & 2 & 3 & 10 \\
        \hline Feltrin E.  & 0 & 0 & 0 & \cellcolor{primarycolor}0 & 2 & 5 & 7 \\
        \hline Michelon R. & 0 & 0 & 0 & 0 & 0 & \cellcolor{primarycolor}7 & 7 \\
        \hline Orlandi G.  & 0 & \cellcolor{primarycolor}3 & 1 & 0 & 3 & 3 & 10 \\
        \hline
        \textbf{Totale ruolo} & 5 & 7 & 1 & 0 & 19 & 29 & 61 
    \end{tabularx}
...
\textbf{Progettista} & 0 & 0,00\texteuro\\
\hline
\textbf{Programmatore} & 16 & 240,00 \texteuro \\ 
\hline
\textbf{Verificatore} & 27 & 405,00\texteuro \\ 
\hline
\rowcolor{primarycolor}
\textbf{Totale} & 56 & 960,00\texteuro \\
\end{tabularx}
%}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \hline
        \textbf{Totale ruolo} & 4 & 5 & 2 & 44 & 0 & 12 & 67 \\
    \end{tabularx}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \textbf{RES}  & 4 & 4 & 0 & 120,00\texteuro & 120,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{AMM}  & 5 & 5 & 0 & 100,00\texteuro & 100,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{AN}   & 2 & 2 & 0 & 50,00\texteuro & 50,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{PROJ} & 44 & 44 & 0 & 1100,00\texteuro & 1100,00\texteuro & 0,00\texteuro \\
        \hline
        ...
        \hline
        \rowcolor{primarycolor}
        \textbf{TOT} & 100 & 67 & 33 & 2045,00\texteuro & 1550,00\texteuro & 495,00\texteuro \\
    \end{tabularx}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        \textbf{Membri} & $\operatorname{\textbf{Re}}$ & $\mathrm{\textbf{Am}}$ & \textbf{An} & \textbf{Proj} & \textbf{Prgm} & \textbf{Ver} & \textbf{Totale} \\
        \hline
        \textbf{Bresolin G.} & 0 & 0 & 1 & 1 & 7 & 10 & 17 \\
        \hline
        \textbf{Ciriolo I.}  & 0 & 0 & 1 & 2 & 11 & 0 & 14 \\
        \hline
        \textbf{Campese M.}  & 0 & 3 & 0 & 2 & 4 & 5 & 14 \\
        \hline
        \textbf{Dugo A.}     & 0 & 1 & 0 & 0 & 8 & 9 & 16 \\
        \hline
        \textbf{Feltrin E.}  & 0 & 0 & 0 & 4 & 7 & 4 & 15 \\
        \hline
        \textbf{Michelon R.} & 0 & 0 & 0 & 3 & 12 & 0 & 15 \\
        \hline
        \textbf{Orlandi G.}  & 6 & 0 & 0 & 2 & 3 & 1 & 12 \\
        \hline
        \textbf{Totale ruolo} & 6 & 4 & 2 & 14 & 52 & 29 & 107 \\
    \end{tabularx}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \textbf{AN}   & 2 & 2 & 0 & 50,00\texteuro & 50,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{PROJ} & 14 & 14 & 0 & 350,00\texteuro & 350,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{PROG} & 48 & 52 & 8 & 720,00\texteuro & 780,00\texteuro & 60,00\texteuro \\
        \hline
        \textbf{VER}  & 29 & 29 & 0 & 435,00\texteuro & 435,00\texteuro & 0,00\texteuro \\
        \hline
        \rowcolor{primarycolor}
        \textbf{TOT} & 103 & 107 & 0 & 1815,00\texteuro & 1875,00\texteuro & 60,00\texteuro \\
    \end{tabularx}
...
\subsubsubsection{Rischi occorsi e loro mitigazione}
\begin{itemize}
    \item \textbf{RT.1}: la scarsa esperienza pregressa nell'ambito del implementazione di componenti software ha rallentato il raggiungimento degli obiettivi in questo sprint. Lo studio personale di dispense e documentazione relativa a tale ambito, assieme a sessioni di peer programming, hanno però permesso di portare a termine gli obiettivi prefissati nella realizzazione della codifica e nel completamento del documento "Specifica tecnica".
\end{itemize}
\subsubsubsection{Pianificazione futura}
\begin{itemize}
...
\subsubsection{Retrospettiva}
\begin{itemize}
    \item La codifica, sebbene sia stata molto impegnativa, ha evidenziato nel corso dello sprint un miglioramento in termini di efficienza temporale, grazie a sessioni di peer programming e grazie all'utilizzo di una impostazione uniforme e chiara definita dai membri del team ad inzio sprint;
    \item In particolare, le sessioni di peer programming hanno permesso di ridurre il tempo di codifica, velocizzando la risoluzione 
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \hline
        \textbf{Ciriolo I.}  & 0 & 0 & 1 & 0 & 11 & 3 & 15 \\
        \hline
        \textbf{Campese M.}  & 0 & 0 & 1 & 2 & 12 & 1 & 16 \\
        \hline
        \textbf{Dugo A.}     & 0 & 0 & 0 & 0 & 9 & 9 & 13 \\
        \hline
        \textbf{Feltrin E.}  & 0 & 4 & 0 & 1 & 3 & 4 & 16 \\
        \hline
        \textbf{Michelon R.} & 0 & 0 & 0 & 0 & 1 & 8 & 9 \\
        \hline
        \textbf{Orlandi G.}  & 0 & 0 & 0 & 0 & 3 & 1 & 13 \\
        \hline
        \textbf{Totale ruolo} & 5 & 4 & 2 & 3 & 50 & 33 & 97 \\
    \end{tabularx}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{c|X|X|X|X|X|X|X}
        ...
        \textbf{PROJ} & 3 & 3 & 0 & 75,00\texteuro & 75,00\texteuro & 0,00\texteuro \\
        \hline
        \textbf{PROG} & 48 & 49 & 8 & 720,00\texteuro & 735,00\texteuro & 15,00\texteuro \\
        \hline
        \textbf{VER}  & 33 & 35 & 0 & 495,00\texteuro & 525,00\texteuro & 30,00\texteuro \\
        \hline
        \rowcolor{primarycolor}
        \textbf{TOT} & 95 & 98 & 0 & 1570,00\texteuro & 1615,00\texteuro & 45,00\texteuro \\
    \end{tabularx}
...
\begin{itemize}
    ...
    \item Continuazione stesura Manuale utene;
    \item Aggiornamento Piano di qualifica;
    \item Aggiornamento Piano di progetto;
    \item Stesura verbali relativi allo sprint.
\end{itemize}
...
\subsubsubsection{Pianificazione futura}
\begin{itemize}
    \item Il team a seguito del seguente sprint ritiene coerente e valida la pianificazione futura stilata precedentemente, la quale non richiede dunque alcuna modifica da apportare.
\end{itemize}
\subsubsubsection{Preventivo a finire}
\begin{itemize}
...
\subsubsection{Retrospettiva}
\begin{itemize}
    \item La codifica delle componenti di frontend, seppur a fronte della poca esperienza pregressa, grazie a sessioni di peer programming e alla condivisione di conoscenze, ha permesso al team di concludere la codifica pianificata senza alcun ritardo;
    \item In particolare, le sessioni di peer programming hanno permesso di ridurre il tempo di codifica, velocizzando la risoluzione 
    delle relative problematiche, grazie alla condivisione tra i membri del team delle proprie conoscenze che hanno permesso di evitare dilungamenti nella fase di codifica;
    \item Il rapporto ore produttive ed effettive riflette l'inesperienza temporanea nell'attività di codifica, ma riprende positivamente verso la fine dello sprint;
    \item Il team ha fatto emergere un apprezzamento nei confronti della granularità dei task relativi all'implementazione delle componenti di frontend e dei test di sistema, i quali hanno permesso di attuare la pianificazione iniziale senza discostamenti.
\end{itemize}
