...
\hline
    ...
    \hline
    \endlastfoot
    TA.1 & Verificare che l'utente, durante la configurazione del modello LLM, possa: \newline 1. Avviare la configurazione del modello LLM; \newline 2. Inserire le credenziali e i parametri richiesti; \newline 3. Confermare la configurazione; \newline 4. Visualizzare un messaggio di errore a causa di credenziali o parametri errati; \newline 5. Correggere le credenziali o i parametri errati e ripetere il processo di configurazione. & UC1.1, UC2 & I \\
    \hline
    TA.2 & Verificare che l'utente, durante la configurazione del vector database, possa: \newline 1. Avviare la configurazione del vector database; \newline 2. Inserire le credenziali e i parametri richiesti; \newline 3. Confermare la configurazione; \newline 4. Visualizzare un messaggio di errore a causa di credenziali o parametri errati; \newline 5. Correggere le credenziali o i parametri errati e ripetere il processo di configurazione. & UC1.2, UC3 & I \\
    \hline
    TA.3 & Verificare che l'utente, durante la configurazione del modello di embeddings, possa: \newline 1. Avviare la configurazione del modello di embeddings; \newline 2. Inserire le credenziali e i parametri richiesti; \newline 3. Confermare la configurazione; \newline 4. Visualizzare un messaggio di errore a causa di credenziali o parametri errati; \newline 5. Correggere le credenziali o i parametri errati e ripetere il processo di configurazione. & UC1.3, UC4 & I \\
    \hline
    TA.4 & Verificare che l'utente, durante la configurazione del sistema di archiviazione documenti, possa: \newline 1. Avviare la configurazione del sistema di archiviazione documenti; \newline 2. Inserire le credenziali e i parametri richiesti; \newline 3. Confermare la configurazione; \newline 4. Visualizzare un messaggio di errore a causa di credenziali o parametri errati; \newline 5. Correggere le credenziali o i parametri errati e ripetere il processo di configurazione. & UC1.4, UC5 & I \\
    \hline
    TA.5 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Caricare un insieme di documenti valido nell'area di staging;\newline
    3. Confermare il caricamento dei documenti presenti nell'area di staging verso il sistema di archiviazione e il vector database;\newline
    4. Visualizzare un messaggio di conferma una volta che i documenti sono stati caricati correttamente. & UC22 & I \\
    \hline
    TA.6 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Caricare un documento valido nell'area di staging che presenta lo stesso nome e formato di un documento già presente nel sistema;\newline
    3. Confermare il caricamento del documento presente nell'area di staging verso il sistema di archiviazione e il vector database;\newline
    4. Visualizzare un messaggio di conferma una volta che il documento è stato caricato correttamente. & UC23, UC22 & I \\
    \hline
    TA.7 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Caricare un insieme di documenti validi nell'area di staging che presentano gli stessi nomi e formati di documenti già presenti nel sistema;\newline
    3. Confermare il caricamento dei documenti presenti nell'area di staging verso il sistema di archiviazione e il vector database;\newline
    ...
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Selezionare un documento presente nel sistema di archiviazione;\newline
    3. Richiedere di visualizzare il contenuto del documento selezionato;\newline
    4. Visualizzare il contenuto del documento selezionato. & UC25 & I \\
    \hline
    TA.9 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare il documento che vuole eliminare;\newline
    4. Richiedere di eliminare il documento selezionato;\newline
    5. Visualizzare un messaggio di conferma una volta che il documento è stato eliminato correttamente. & UC26, UC25 & I \\
    \hline
    TA.10 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare i documenti che vuole eliminare;\newline
    4. Richiedere di eliminare i documenti selezionati;\newline
    5. Visualizzare un messaggio di conferma una volta che i documenti sono stati eliminati correttamente. & UC27, UC26, UC25 & I \\
    \hline
    TA.11 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare il documento che vuole occultare;\newline
    4. Richiedere di occultare il documento selezionato;\newline
    ...
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare i documenti che vuole occultare;\newline
    4. Richiedere di occultare i documenti selezionati;\newline
    5. Visualizzare un messaggio di conferma una volta che i documenti sono stati occultati correttamente. & UC29, UC28, UC25 & I \\
    \hline
    TA.13 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare il documento che vuole riabilitare;\newline
    4. Richiedere di riabilitare il documento selezionato;\newline
    5. Visualizzare un messaggio di conferma una volta che il documento è stato riabilitato correttamente. & UC30, UC25 & I \\
    \hline
    TA.14 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti presenti nel sistema di archiviazione;\newline
    3. Selezionare i documenti che vuole riabilitare;\newline
    4. Richiedere di riabilitare i documenti selezionati;\newline
    5. Visualizzare un messaggio di conferma una volta che i documenti sono stati riabilitati correttamente. & UC31, UC30, UC25 & I \\
    \hline
    TA.15 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista dei documenti caricati;\newline
    3. Richiedere al sistema di effettuare una ricerca dei documenti;\newline
    4. Visualizzare i risultati della ricerca eseguita. & UC32 & I \\
    \hline
    TA.16 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista delle chat;\newline
    3. Selezionare una chat;\newline
    4. Richiedere di visualizzare il contenuto della chat selezionata;\newline
    5. Visualizzare il contenuto della chat selezionata. & UC33, UC42 & I \\
    \hline
    TA.17 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista delle chat esistenti;\newline
    3. Selezionare la chat che vuole rinominare;\newline
    4. Richiedere di rinominare la chat selezionata;\newline
    5. Visualizzare un messaggio di conferma una volta che la chat è stata rinominata correttamente. & UC38, UC33 & I \\
    \hline
    TA.18 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista delle chat esistenti;\newline
    3. Selezionare la chat che vuole eliminare;\newline
    4. Richiedere di eliminare la chat selezionata;\newline
    5. Visualizzare un messaggio di conferma una volta che la chat è stata eliminata correttamente. & UC36, UC33 & I \\
    \hline
    TA.19 & Verificare che l'utente possa:\newline
    1. Accedere al sistema con le credenziali corrette;\newline
    2. Visualizzare la lista delle chat esistenti;\newline
    3. Selezionare le chat che vuole eliminare;\newline
    4. Richiedere di eliminare le chat selezionate;\newline
