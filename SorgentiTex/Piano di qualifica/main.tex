...
\hline
TS.126 & Verificare che il sistema garantisca il servizio per almeno un utente. & RQ.O.2 & I \\
\hline
TS.127 & Verificare che in caso di caduta dalle connessione, l’applicazione vada in fallback su un modello AI locale. & RQ.OP.3 & I \\
\hline
TS.128 & Verificare che nel caso in cui l’utente formuli una richiesta non pertinente al dataset di addestramento, il chatbot fornisca una risposta cortese in cui espone la sua incapacità nel fornire una risposta alla domanda. & RQ.D.4 & I \\
\hline
TS.129 & Verificare che il chatbot sia in grado di fare caching: se l’utente formula più volte la stessa domanda, il chatbot fornisce la risposta elaborata alla prima occorrenza della domanda. & RQ.OP.5 & I \\
\hline
TS.130 & Verificare che l’eliminazione di un documento dallo spazio di storage porti all’eliminazione dei metadati del relativo documento, ma non all’eliminazione degli emmbeddings generati dallo stesso. & RQ.D.6 & I \\
\hline
TS.131 & Verificare che il prodotto software rispetti tutto ciò che è descritto da (Norme di progetto). & RV.O.1 & I \\
\hline
TS.132 & Verificare che il prodotto software rispetti tutto ciò che è descritto da (Piano di qualifica). & RV.O.2 & I \\
\hline
TS.133 & Verificare che l’applicazione web garantisca la presenza di almeno un modello AI locale. & RV.O.3 & I \\
\hline
TS.134 & Verificare che le chat siano salvate in automatico in un database. & RV.O.4 & I \\
\hline
TS.135 & Verificare che i documenti caricati siano memorizzati in un sistema di archiviazione. & RV.O.5 & I \\
\hline
TS.136 & Verificare che il sistema garantisca il servizio per almeno un utente. & RP.O.1 & I \\
\hline
