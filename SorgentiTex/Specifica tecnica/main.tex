...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{persistChat(messages:List<Message>, chatId: ChatId}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \code{persistChat(messages:List<PostgresMessage>, chatId:int): PostgresChatOperationResponse}\\
        Metodo che prende una lista di PostgresMessages e la rende persistente, restituendo un PostgresChatOperationResponse, che rappresenta l'esito della operazione.
