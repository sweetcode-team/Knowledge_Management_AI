    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textit{Typescript}: \\
                ...
                (Ultimo accesso: 2024-03-29));
        \end{itemize}
        \item \textit{(Glossario v2.0.0(9))};
        \item \textit{(Piano di progetto v2.27.1(1))};
        \item \textit{(Piano di qualifica v2.25.8(1))};
...
Le componenti sono assemblate insieme utilizzando Docker Compose per facilitare l'esecuzione e la gestione di più container docker tramite il file \code{compose.yml}, \code{testcompose.yml}.\\ %, \code{release.yml} e \code{test.yml} ?(legati alle actions?)
...
RF.D.46.2 & NS \\
\hline
RF.D.47 &  MessageCard: vedi \vedi{MessageCardDettaglio}.\\
\hline
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/AskChatbot.png}
...
\end{itemize}
 ...
 \begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/ChangeConfiguration.png}
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/DeleteDocs.png}
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=17cm]{img/EnableDocs.png}
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/GetConfiguration.png}
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/GetDocs.png}
...
\begin{figure}[H]
    \centering        
    \includegraphics[width=16.5cm]{img/ViewDocContent.png}
