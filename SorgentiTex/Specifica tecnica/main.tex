...
\subsubsection{SetUp(Primo avvio)}%TODO da completare quando ci sono gli screen
\subsubsubsection{Descrizione}
...
\endlastfoot
\hline
RF.O.1.1.1 & \\ %selezionare modello llm presente al primo avvio
\hline
RF.O.1.2.1 & \\ % selezionare vector db  presente al primo avvio
\hline
RF.O.1.3.1 & \\  %selezionare modello embeddingspresente al primo avvio
\hline
RF.O.1.4.1 & \\ % selezionare sistema di archiviazione presente al primo avvio
\hline
RF.O.3 & \\ %seleziona
\hline
RF.O.3.1 & \\ %se
...
%CHATBOT-FRONTEND toDO
\subsection{SettingsAppearance}
\subsubsection{Descrizione delle sottocomponenti}

\subsubsubsection{AppearanceHeader}
