...
\subsubsubsection{Descrizione}
Questa componente ha il compito di gestire la configurazione del sistema. %TODO
È costituita da:
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
       ...
       % Metodo per ottenere un BaseMessage a partire da un Message;
        ...
        %Metodo per creare una chat tramite postgresChatORM, ritornando il suo ChatId;
...
\begin{itemize}
    ...
    \begin{itemize}  
        \item \code{chatId: ChatId};
        \item \code{messageResponse: Message};
        \item \code{status: boolean}.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
       % \item \code{chromadb: chromadbCollection}; ?
    ...
    \begin{itemize}
        ...
        \item \code{getRetriever(embeddingModel:LangchainEmbeddingModel): BaseRetriever}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \code{dgetDeleteDocumentsPort(): DeleteDocumentsPort}\\ 
        Metodo per eliminare una lista di documenti tramite outPort dal sistema di archiviazione a partire dai loro id.
...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \item \code{getChatPreviewFrom():}\\ \code{ChatPreview}
...
\subsection{GetConfiguration}%TODO
\subsubsection{Diagramma delle classi}
\subsubsection{Lista delle sottocomponenti}
...
%
%
\subsubsubsection{GetConfigurationPort}%TODO
...
\subsubsubsection{GetConfigurationPostgres}%TODO
...
\subsubsubsection{GetConfigurationService}%TODO
...
\subsubsubsection{GetConfigurationUseCase}%TODO
...
\begin{comment} % TODO: capire cosa fare con substitute (route a parte o unirla a upload)
