...
%\hline
%RF.O.36.1 & GetConfigurationService: vedi \vedi{GetConfigurationServiceDettaglio}\\ visualizza errore creazione nuova chat esistente
...
\hline
RF.D.47 &  MessageCard: vedi \vedi{MessageCardDettaglio}.\\ %ascoltare tramite audio un messaggio
\hline
...
%requisiti non soddisfatti
    %\item RF.D.45; %domande suggerite in chat vuota
    %\item RF.D.46; %inviare domanda suggerita 
   % \item RF.D.46.1; %seleziona dom. suggerita
    %\item RF.D.46.2; %%conferma invio dom. suggerita
    %\item RF.OP.49; %attiva modalità vocale
    %\item RF.OP.50; %disattiva mod. vocale
...
\endlastfoot
\hline
RF.O.15 & DocumentsList: vedi \vedi{DocumentsList}.\\ %visualizzare i documenti presenti nel sistema di archiviazione
\hline
...
\hline
RF.O.18 &  StagingArea: vedi \vedi{StagingAreaDettaglio}. \\ %tentativo formato caricato  in area di staging non supportato
\hline
...
\hline
RF.O.22.1.1 & StagingArea: vedi \vedi{StagingAreaDettaglio}.\\% visualizza errore caricamento del documento sistema archiviazione
\hline
...
\subsubsubsection{Tracciamento dei requisiti}%TODO trasformare in tabella
\begin{itemize}
    \item RF.O.1.1.1; %selezionare modello presente al primo avvio
    \item RF.O.1.2.1;% selezionare vector db  presente al primo avvio
    \item RF.O.1.3.1; % selezionare modello embeddingspresente al primo avvio
    \item RF.O.1.4.1; % selezionare sistema di archiviazione presente al primo avvio
    %requisiti sul poter vedere i modelli disponibili di vector store , embedding llm etc
    \item RF.O.2;
    \item RF.O.2.1;
    \item RF.O.3;
    \item RF.O.3.1;
   ...
   \item  RF.O.6.1 % \\L’utente deve poter selezionare un solo modello LLM tra quelli resi disponibili durante il cambio di scelta de
...
\begin{itemize}
     ...
     \item ; %backend su postgresorm creare nuova chat e visualizzare errore se vuota già esiste
     \item RF.O.36;
     \item RF.O.36.1;
     \item RF.O.52;
     \item RF.OP.57;
     \item RF.O.59;% backend askchatbot service
     \item RF.O.60. %-Una chat viene creata in modo consistente nel database solamente dopo un messaggio da parte dell’utente e della relativa risposta da parte del chatbot postgreschatorm
\end{itemize}
\end{comment}
...
\endlastfoot
\hline
RF.O.6 & PostgresChatORM: vedi \vedi{PostgresChatORMDettaglio}.\\
...
\endlastfoot
\hline
RF.O.24 & GetDocumentFacadeService: vedi \vedi{GetDocumentFacadeServiceDettaglio}.\\
\end{xltabular}
