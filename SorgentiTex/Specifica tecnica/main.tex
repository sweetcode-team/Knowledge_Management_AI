...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{embedDocuments(documentIds:List<DocumentIds>):}\\ \code{List<DocumentOperationResponse>}\\
...
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
        \item \code{getDocuments: GetDocuments};
...
\subsubsubsection{GetDocuments}
\label{GetDocumentsDettaglio}
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
        \item \code{outPort: GetDocumentsPort}.
    \end{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{getDocuments(documentIds:List<DocumentId>):}\\ \code{List<PlainDocument>}\\
...
\subsubsubsection{GetDocumentsPort}
...
\subsubsubsection{GetDocumentsAWSS3}
...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{getDocuments(documentIds:List<DocumentId>): List<PlainDocument>}\\
...
\begin{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{createChunks(documents:List<langchain.Document>):}\\ \code{List<langchain.Document>}\\
...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{enableDocuments(documentIds:List<string>):}\\ \code{List<DocumentOperationResponse>}\\
...
\begin{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{enableDocuments(documentIds:List<DocumentId>):}\\ \code{List<DocumentOperationResponse>}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \code{info: ChatInfo};
        \item \code{lastMessageSnippet: string}.
    \end{itemize}
\end{itemize}

\subsubsubsection{ChatInfo}
Vedi \vedi{ChatInfoDettaglio}.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \code{getChatPreviewFrom(chat:PostgresChatPreview):}\\ \code{ ChatPreview}
...
\begin{itemize}
    ...
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{getDocumentsStatus(documentIds:List<DocumentId>)}\\ \code{Map<DocumentId; DocumentStatus>}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \code{toDocumentMetadataFrom(document:AWSDocumentMetadata):}\\ \code{DocumentMetadata}\\
...
\begin{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{renameChat(chatId:ChatId, title:string): boolean}\\
...
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
        \item \code{documentUploader: DocumentUploader};
        \item \code{embeddingsUploader: EmbeddingsUploader}.  
    \end{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
...
\subsubsubsection{DocumentUploader}
\label{DocumentUploaderDettaglio}
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
        \item \code{outPort: DocumentUploaderPort}.
    \end{itemize}
    \item \textbf{Metodi}:
    \begin{itemize}
        \item \code{uploadDocuments(documents:List<Document>, forceUpload:boolean):}\\ \code{ List<DocumentOperationResponse>}\\ 
...
\subsubsubsection{DocumentUploaderPort}
...
\begin{itemize}
    \item \textbf{Attributi}:
    \begin{itemize}
        \item \code{documentToText: DocumentToText};
...
\subsubsubsection{DocumentToText}
Vedi \vedi{DocumentToTextDettaglio}.
...
\subsubsubsection{GetDocuments}
Vedi \vedi {GetDocumentsDettaglio}.

\subsubsubsection{GetDocumentsStatus}
Vedi \vedi{GetDocumentsStatusDettaglio}.

\subsubsubsection{GetDocumentsPort}
Vedi \vedi{GetDocumentsPortDettaglio}.

\subsubsubsection{GetDocumentsStatusPort}
Vedi \vedi{GetDocumentsStatusPortDettaglio}.

\subsubsubsection{GetDocumentsAWSS3}
Vedi \vedi{GetDocumentsAWSS3Dettaglio}.
